    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "产品形态是同一工作台：对话、运行追踪、知识检索、技能路由、回归评测、能力锁、能力全景。问句先锁 read / mutate / abstain：制度问答只输出带条款编号的原句，开通 VPN 只起草工单，人点允许才提交。无后端时走浏览器内 Guest Runtime，有 Hono + SQLite 时走服务端 Loop，协议层保持一致。",
        ],
      },
      {
        heading: "核心模块",

...
export const WORKS: Work[] = [
  {
    ...
    slug: "ownagent",
    title: "OwnAgent",
    subtitle: "企业级 AI 知识助手 · 全栈可部署",
    hook: "先搜广场、再问 AI、答完共享 — Docker 一键给客户部署",
    desc: "React + Hono + SQLite 全栈产品：知识库、知识广场、管理后台、Agent Loop、Hybrid RAG。",
    impact: "个人项目 · 可交付",
    kind: "own-agent",
    stack: ["Hono", "SQLite", "Docker", "Agent Loop", "知识广场", "Hybrid RAG"],
    teaser: "对话 · 技能 · 全景",
    accent: "#8b5cf6",
    tier: "flagship",
    featured: true,
